...
parser.add_argument("mode",type=str, choices=["weak","full"],help="Mode of operation")
parser.add_argument("--tls",help="Add this option if you want to connect to the MX using STARTTLS in full mode",
        action="store_true")
...
if args.mode == "weak":
    ...
    password = getpass.getpass("[SYSTEM]: Insert the password for the previously entered email: ")
